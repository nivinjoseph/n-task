...
export abstract class TaskPool implements Disposable
{
...
class TaskWorkerInstance implements Disposable
{
    ...
    private readonly _worker: WorkerAdapter;
    ...
    public constructor(worker: WorkerAdapter)
    {
